...
declare module BABYLON {
    function isPresent(x: any): boolean;
    class TransitionCamera extends TargetCamera {
        private yaw_deg;
        private pitch_deg;
        private distance;
        private targetX;
        ...
        tumbleSensitivity: number;
        trackSensitivity: number;
        wheelPrecision: number;
        pinchPrecision: number;
        nFrames: number;
        fps: number;
        ...
        groundLevel: number;
        prevUpdate_secs: number;
        inputs: TransitionCameraInputsManager;
        constructor(name: string, scene: Scene, yaw_deg: number, pitch_deg: number, minDistance: number, maxDistance: number, distance: number, targetPos: Vector3, fov_deg?: number, inertia?: number, groundLevel?: number, tumbleSensitivity?: number, trackSensitivity?: number, wheelPrecision?: number);
        attachControl(renderCanvas: HTMLCanvasElement, noPreventDefault?: boolean): void;
        detachControl(renderCanvas?: HTMLCanvasElement): void;
        _checkInputs(): void;
        CalcPointerOffset(x: any, y: any): any;
        CalcPosition(): void;
        GetTargetPos(): Vector3;
        private _getCurrState();
        private _restoreState(state);
        /**
         * @override
         ...
         */
        _getViewMatrix(): Matrix;
        private InertialStep(iv, nSteps);
        OnTumble(offsetX: number, offsetY: number): void;
        OnTrack(offsetX: number, offsetY: number): void;
        OnPick(offsetX: number, offsetY: number, pickResult: PickingInfo, mEvent: MouseEvent): void;
        OnDolly(offset: number): void;
        OnLeftClick(): boolean;
        OnRightClick(): boolean;
        OnFrontClick(): boolean;
        OnAftClick(): boolean;
        OnTopClick(): boolean;
        OnBottomClick(): boolean;
        ChangePerspectiveView(yaw_deg: number, pitch_deg: number, distance: number): void;
        OnOrthoLeftClick(): boolean;
        OnOrthoRightClick(): boolean;
        OnOrthoFrontClick(): boolean;
        OnOrthoAftClick(): boolean;
        OnOrthoTopClick(): boolean;
        OnOrthoBottomClick(): boolean;
        OrthoView(yaw_deg: number, pitch_deg: number, AR: number, horzCentre: number, vertCentre: number): void;
        ...
        private StateChangeAnimation(startState, endState);
        getClassName(): string;
    }
}

declare module BABYLON {
    class TransitionCameraInputsManager extends CameraInputsManager<TransitionCamera> {
        constructor(camera: TransitionCamera);
        addMouseWheel(): TransitionCameraInputsManager;
        addPointers(): TransitionCameraInputsManager;
        addKeyboard(): TransitionCameraInputsManager;
    }
}
...
declare module BABYLON {
    var TransitionCameraKeys: {
        ...
        BackView: string;
        TopView: string;
        UnderneathView: string;
        OrthoLeftView: string;
        OrthoRightView: string;
        OrthoFrontView: string;
        OrthoBackView: string;
        OrthoTopView: string;
        OrthoUnderneathView: string;
        Fullscreen: string;
    };
    class TransitionCameraKeyboardMoveInput implements ICameraInput<TransitionCamera> {
        camera: TransitionCamera;
        private _onKeyDown;
        private _tumbleLeft;
        private _tumbleRight;
        private _tumbleUp;
        private _tumbleDown;
        private _trackLeft;
        private _trackRight;
...
declare module BABYLON {
    class TransitionCameraMouseWheelInput implements ICameraInput<TransitionCamera> {
        camera: TransitionCamera;
        private _wheel;
        private _observer;
        wheelPrecision: number;
...
declare module BABYLON {
    ...
    class TransitionCameraPointersInput implements ICameraInput<TransitionCamera> {
        camera: TransitionCamera;
        private _pointerInput;
        private _observer;
        private _onMouseMove;
